...
species_vars <- list(
`Pseudacris triseriata` = c("wetland", "marais", "marecage", "earthenv_geomflat", "flat", "open"), 
...
`Coturnicops noveboracensis` = c("earthenv_geomflat", "flat", "marais", "wetland", "prairie_humide", "glaciomarin", "organique", "logdistance_to_coaststlawrence", "forest"), 
