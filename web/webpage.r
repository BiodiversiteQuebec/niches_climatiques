...
for(ii in seq_along(pages)){
  ...
  #keepsp <- info$species[info$group == "reptiles"]
      ...
      <div class=\"col3\" style=\"width: 24vw;\">
        ...
        <div class=\"container\" style=\"border: 0px solid red;\">
          <a class=\"aim\" target=\"_blank\" href=\"", url,"\">
            <div class=\"infotop\">", period, "<br>scénario = ", "2041-2070_gfdl-esm4_ssp370", "</div>
            <!-- <a class=\"aim\" target=\"_blank\" href=\"",url,"\"> -->
  ...
  con <- file(paste0("/home/frousseu/Documents/github/niches_climatiques/html/", names(pages)[ii], ".html"), open = "w+b")#, encoding = "UTF-8")
  sink(con)
